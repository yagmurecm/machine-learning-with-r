...
modelData <- df %>% dplyr::select(Hospital , Sex , Patient_Followup_Status , Case_Status , Contact , Pregnancy , Notification_District , Intensive_care , Intubation , Age , CT_Result , CT , Pneumonia , Process_Status , Ferritin , CRP , Oxygen)
